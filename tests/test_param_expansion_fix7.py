#!/usr/bin/env python3
"""
Test FIX #7: Advanced parameter expansion

Tests all the new expansion patterns
"""
    ...
    if "[TEST MODE]" in result:
        for line in result.split('\n'):
            if "Would execute:" in line:
                actual = line.split("Would execute:")[-1].strip()
                break

    success = expected in (actual or '')
